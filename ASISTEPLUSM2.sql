-- =====================================================
-- PROYECTO: ASISTE PLUS
-- MOTOR: SQL SERVER
-- VERSION FINAL - CUMPLE RUBRICA
-- =====================================================
...
-- =====================================================
-- INSERTS (10 REGISTROS MINIMO POR TABLA)
-- =====================================================
...
('6A','Mañana',1),('6B','Mañana',2),('7A','Tarde',3),('7B','Tarde',4),
('8A','Mañana',5),('8B','Mañana',6),('9A','Tarde',7),('9B','Tarde',8),
('10A','Mañana',9),('11A','Mañana',10);
...
('Asistió',1,1),('Asistió',2,2),('Falta',3,3),('Asistió',4,4),
('Falta',5,5),('Asistió',6,6),('Asistió',7,7),('Falta',8,8),
('Asistió',9,9),('Asistió',10,10);
GO

-- =====================================================
-- CONSULTAS DE NEGOCIO (SELECT)
-- =====================================================

-- 1. Cantidad de estudiantes por curso
SELECT c.nombre_curso, COUNT(e.id_estudiante) AS total_estudiantes
FROM curso c
INNER JOIN estudiante e ON c.id_curso=e.id_curso
GROUP BY c.nombre_curso;

-- 2. Total de asistencias por estudiante
...
-- 3. Cursos con estudiantes registrados
...
-- 4. Promedio de asistencias por estudiante (AVG)
